...
const EditProductCategoryDialog = ({ name, id }: Props) => {
  const { mutateAsync, isPending } = useUpdateProductCategory()
  ...
  const handleUpdateProductCategory = (data: FormSchemaType) => {
    try {
      const sendData = {
        id: id,
        name: data.name,
